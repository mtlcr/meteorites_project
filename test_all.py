...
TASKS = (GradingTask(0, 'kf_nonoise', 6, ESTIMATE_TIMEOUT),
         GradingTask(1, 'kf_nonoise', 6, ESTIMATE_TIMEOUT),
         GradingTask(2, 'estimate', 6.5, ESTIMATE_TIMEOUT),
         GradingTask(3, 'estimate', 6.5, ESTIMATE_TIMEOUT),
         GradingTask(4, 'estimate', 6.5, ESTIMATE_TIMEOUT),
         GradingTask(5, 'estimate', 6.5, ESTIMATE_TIMEOUT),
         GradingTask(6, 'estimate', 6.5, ESTIMATE_TIMEOUT),
         GradingTask(7, 'estimate', 6.5, ESTIMATE_TIMEOUT),
         GradingTask(8, 'estimate', 6.5, ESTIMATE_TIMEOUT),
         GradingTask(9, 'estimate', 6.5, ESTIMATE_TIMEOUT),
         ...
         GradingTask(9, 'defense', 2, DEFENSE_TIMEOUT))
